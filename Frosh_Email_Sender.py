...
# put these three txt files above in the folder called 'emails'
...
# put these attachments in a folder called 'attachments'
    ...
    with open("./emails/" + NAME_EMAIL, mode='r+', encoding='utf-8') as contacts_file:
        ...
        for name, email in zip(names, emails):
            try:
                ...
                del msg
                already_sent_emails.write(name + ", " + email)

            except Exception as e:
                print("There was an error with the email addressed to " + name + " at " + email)
                contacts_file.write(name + ", " + email)
